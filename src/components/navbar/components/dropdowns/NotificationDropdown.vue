...
const notifications: INotification[] = [
  ...
  {
    message: '2 operational DID deleted',
    icon: 'error_outline',
    id: 3,
    separator: true,
  ...
  {
    message: 'Monthly application approval rate exceeded by 10%',
    icon: 'trending_up',
    id: 6,
    separator: true,
  ...
  {
    message: '1 application approved',
    icon: 'alarm',
    id: 7,
    separator: false,
  ...
  {
    message: 'New DID update available',
    icon: 'system_update',
    id: 8,
    separator: true,
