...
<template>
  <VaCard>
    <VaCardTitle class="flex items-start justify-between">
      <h1 class="card-title text-secondary font-bold uppercase">Third party authentication</h1>
      <VaButton preset="primary" size="small" to="/projects">View all authentication</VaButton>
    </VaCardTitle>
    <VaCardContent>
