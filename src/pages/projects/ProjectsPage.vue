...
const availableDIDs = ref(['did:ethr:0x123...', 'did:web:example.com', 'did:ion:456...'])
provide('availableDIDs', availableDIDs)
...
const editProject = (project: Project) => {
  ...
  console.log(projectToEdit.value + ' ' + doShowProjectFormModal.value)
}
...
const onProjectDeleted = async (project: Project) => {
  const response = await confirm({
    ...
    message: `Are you sure you want to delete application "${project.project_name}"?`,
    okText: 'Delete',
    size: 'small',
    maxWidth: '380px',
  })
...
<template>
  <h1 class="page-title">Third Party Authentication</h1>
  ...
  <VaCard>
    <VaCardContent>
      <div class="flex flex-col md:flex-row gap-2 mb-2 justify-between">
        ...
        <VaButton icon="add" @click="createNewProject">Application</VaButton>
      </div>
    ...
    >
      <h1 v-if="projectToEdit === null" class="va-h5 mb-4">Add Application</h1>
